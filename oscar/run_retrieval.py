...
def restore_training_settings(args):
    ...
    train_args = torch.load(op.join(args.eval_model_dir, 'pytorch_model.bin'))
...
def main():
    ...
    parser.add_argument("--data_dir", default='/disk2/11811112/Oscar/oscar/datasets/coco_ir', type=str, required=False,
    ...
    parser.add_argument("--eval_model_dir", type=str, default='/disk2/11811112/Oscar/oscar/output0320/checkpoint-29-66390/',
